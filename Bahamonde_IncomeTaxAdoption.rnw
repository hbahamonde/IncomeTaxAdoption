...
When it comes to taxation, the public economics literature focuses predominantly on tax revenues. However, the \emph{politics} of taxation is an equally important matter\footnote{\citet[]{Focanti2013}.}. It is not important only because of the \emph{process}, but also because of the political \emph{consequences} of imposing such policy. We argue that the new income tax was not important because of the extra revenue that income taxation brought to the treasury, but because it triggered a series of institutional investments that helped early states to consolidate. This paper identifies (though not exhaustively) two critical institutions, political competition and bureaucratic consolidation among the elite in the form of oligarchic republics.
