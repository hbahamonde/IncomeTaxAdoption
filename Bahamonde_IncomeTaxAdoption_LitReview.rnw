In \citet[111]{Mamalakis1971}'s words, in Latin America, economic equality reduced political inequality.

\footnote{While emphasizing a different channel, \citet{Baskaran2013} find that fiscal capacities improved levels of governance in 31 sub-Saharan African countries between 1990 and 2005. See also \citet{Altunbas2011}.} 


As explained in \autoref{unpacking}, the Chilean case met these two conditions. Analytically, the \emph{effectiveness} of income taxation on fiscal capacities increased due to the nature of the implementation of the income tax. \citet[566]{Aghion2004} explain how optimal institutional choices result from political settings where all involved actors ``had a voice in the choice of institutions,'' essentially contributing to an equilibrium of quasi-voluntary compliance.\footnote{\citet{Levi:1989lq}.}

This is in line with  \citet[59]{Besley:2011aa} who argue that ``investing in fiscal capacity becomes more attractive [...] when wages or incomes [...] are higher.''\footnote{Similarly, see \citet[647]{Campbell1994} who explain that ``economic development should be directly related to individual and corporate income tax rates.''} \citet{Beramendi2016} also find that investments in fiscal capacities are conditional on the expansion of the industrial sector.


this form of taxation demands the endogenous development of both stronger state institutions and efficient monitoring and enforcement technologies.\footnote{\citet[99]{Lieberman2002a}.} 


From a historical standpoint, its introduction ``was one of the major events in fiscal history that contributed to the \emph{growth in government} observed during the past 150 years.''\footnote{\citet[171]{Aidt2009a}. Emphasis is mine.} Consequently, since taxing incomes involves transforming private income into public property,\footnote{\citet[98]{Musgrave1992}.} 


\footnote{For a review of fiscal sociology, see \citet{Martin2014}.}

In this sense, I follow \citet[169]{Thies2015}, who explains that ``rulers will have an upper hand whenever they monopolize the coercive, political \emph{and} economic resources of a society.''\footnote{Emphasis is mine.} 

Moreover, domestic explanations of state-building centered on the role of sectoral conflicts and taxation, have been overlooked, especially in the developing world.\footnote{Flores-Mac\'ias, in \citet{Flores-Macias2017}. However, a few exceptions are \citet[7-8]{Gallo:1991kx}, \citet{Beramendi2016} and \citet[8]{Saylor:2014aa}. \citet[]{Wheeler2011} \citet{Mares2015} study how inter-elite cooperation and agreements positively impacted state-making in Europe.}
...
While emphasizing a different channel, \citet{Baskaran2013} find that fiscal capacities improved levels of governance in 31 sub-Saharan African countries between 1990 and 2005. % 
`` fiscal capacity has a positive effect on the absence of corruption and the level of democracy because citizens demand more accountability if taxes are high and rulers apparently acquiesce to these demands.'' // it has a number of problems the way they measure things. // that's why they find these results.
...
Similarly, Seligman in 1895 argued that ``[f]iscal conditions are always an outcome of economic relations,''\footnote{In \citet[7]{Martin2009a}.} while Goldscheid in 1925 famously argued that ``tax struggles are among the oldest forms of class struggle.''\footnote{In \citet[168]{Campbell1993}.} 

% As others have pointed out,  ``administrative constraints are identified as the main constraint to the ability of states to collect [the] income tax.''\footnote{\citet[5]{DiJohn2006}.} Political alliances should exist to overcome these logistic, institutional and political domestic challenges. 
...
\textcite[9]{UndaGutierrez2017} explains that in Mexico the lack of credit had previously been one of the industrial sector's main obstacles. In fact, industrial elites started to comply with the income tax in exchange for having credit policies more adequate to the industrial sector.

\textcite[11]{Mamalakis1969} develops a theory of sectoral clashes. The leading sector becomes dominant thanks to the interplay between the government, the dominant sector, and the central bank.

As \textcite[1748]{Baland2008} argue, ``[c]ongressional representation was heavily weighted in favor of rural districts.''


Similarly, \textcite[15]{McBride:1971fv} explains that ``Chile's people live on the soil. Her life is agricultural to the core. \emph{Her government has always been of farm owners. Her Congress is made up chiefly of rich landlords}. Social life is dominated by families whose proudest possession is the ancestral estate.'' Emphases are mine.
